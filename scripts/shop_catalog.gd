...
const ITEMS: Array[Dictionary] = [
	...
	},
	{
		"id": "benen",
		"name": "Tentacles",
		"description": "Heal for 8% of the damage you deal. Ranks 2-5: more lifesteal.",
		"base_price": 62,
		"price_step": 44,
		"max_stacks": SHOP_MAX_STACKS,
		"lifesteal_ratio": 0.08,
		"lifesteal_ratio_step": 0.04,
		"heroes": ALL_HEROES,
		"alias": {
			...
			"warden": {"name": "Plus Drain", "description": "8% of your Plus Beam damage returns as HP."},
				"frostbinder": {"name": "Frost Siphon", "description": "8% of your frost damage returns as HP."},
				"rime": {"name": "Chill Siphon", "description": "8% of your frost damage returns as HP."},
				"cinder": {"name": "Ember Siphon", "description": "8% of your fire damage returns as HP."},
				"pyra": {"name": "Blood Rounds", "description": "8% of your barrage damage returns as HP."},
				"slag": {"name": "Molten Drain", "description": "8% of your damage returns as HP."},
				"ember": {"name": "Witchfire Drain", "description": "8% of your hexfire damage returns as HP."},
				"thorn": {"name": "Venom Siphon", "description": "8% of your poison damage returns as HP."},
				"willow": {"name": "Bloom Siphon", "description": "8% of your damage returns as HP."},
				"stump": {"name": "Sap Siphon", "description": "8% of your damage returns as HP."},
				"sage": {"name": "Fae Siphon", "description": "8% of your damage returns as HP."},
				"volt": {"name": "Wind Siphon", "description": "8% of your damage returns as HP."},
				"nebula": {"name": "Time Siphon", "description": "8% of your damage returns as HP."},
				"astral": {"name": "Starlight Siphon", "description": "8% of your damage returns as HP."},
		},
	},
	{
		"id": "hoverboard",
