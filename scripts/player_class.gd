...
const CLASSES: Array[Dictionary] = [
	...
	},
	{
		...
		"upgrades": ["depth", "shatter", "rime", "heavy", "vitality", "spark_sprite", "gale_push"],
		"kit_q": "frostbinder_ice_spike",
		"kit_e": "frostbinder_frost_nova",
		"kit_r": "frostbinder_glacial_cone",
		"ability_pool": [
