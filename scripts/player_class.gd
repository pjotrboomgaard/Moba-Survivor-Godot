...
const CLASSES: Array[Dictionary] = [
	{
		...
		"animated_menu_bg": "res://assets/ui/tobor_menu_bg_frames",
		"weapon_name": "Blast Cannon",
		"description": "Glass cannon on wheels. Blast Cannon hits hard; buy parts in the shop.",
		"counters": "Strong vs swarms and bosses  ·  Weak vs anything that hits back",
		...
		"upgrades": ["rapid", "heavy", "blast", "aftershock", "vitality", "gun_drone", "push_drone", "scholar", "keen_eye"],
		...
		"ability_pool": [
			...
			"tobor_boiler_burst", "tobor_wrench_toss", "tobor_repair_pulse", "tobor_ironclad_chassis",
		],
	},
	{
		"id": "arclight",
		...
		"upgrades": ["rapid", "heavy", "chain", "volt", "vitality", "gun_drone", "push_drone", "keen_eye", "haste"],
	...
	},
	{
		...
		"chain_count": 0,
		"chain_range": 0.0,
		"damage_taken_multiplier": 0.62,
		"taunt_weight": 0.35,
		"secondary": "wall",
		"secondary_cooldown": 12.0,
		"upgrades": ["plating", "reach", "sweep", "heavy", "vitality", "gun_drone", "push_drone", "boots", "ironhide"],
	...
	},
	{
		...
		"animated_menu_bg": "res://assets/ui/warden_menu_bg_frames",
		...
		"taunt_weight": 1.2,
		"hovering": true,
		"secondary": "vine_tangle",
		"secondary_cooldown": 10.0,
		"upgrades": ["flow", "choir", "lash", "rapid", "vitality", "gun_drone", "ironhide"],
		"kit_q": "warden_tongue_tied",
		"kit_e": "warden_thorn_volley",
		"kit_r": "warden_life_drain",
		"ability_pool": [
			"warden_tongue_tied", "warden_thorn_volley", "warden_life_drain",
			"warden_voodoo_wards", "warden_mending_wave", "warden_entangle",
	...
	# --- Caldera world heroes ---
	{
		...
		"taunt_weight": 1.0,
		"secondary": "heat_burst",
		"secondary_cooldown": 9.0,
		"upgrades": ["rapid", "heavy", "chain", "vitality", "ember_sprite", "heat_gust"],
	...
	},
	{
		...
		"taunt_weight": 1.0,
		"secondary": "blast_jump",
		"secondary_cooldown": 9.0,
		"upgrades": ["rapid", "heavy", "blast", "vitality", "ember_sprite", "heat_gust"],
	...
	},
	{
		...
		"counters": "Strong vs armour and brutes",
		"damage_type": DamageType.IMPACT,
		"weapon": Weapon.CONE_SLAM,
		"effect_style": EffectStyle.ARC,
		"body_color": "5c2e1e",
		...
		"taunt_weight": 0.45,
		"secondary": "magma_armor",
		"secondary_cooldown": 11.0,
		"upgrades": ["plating", "reach", "sweep", "heavy", "vitality", "ember_sprite", "heat_gust"],
		"kit_q": "slag_boulder_hurl",
	...
	},
	{
		...
		"taunt_weight": 1.1,
		"secondary": "cinder_veil",
		"secondary_cooldown": 12.0,
		"upgrades": ["flow", "lash", "heavy", "vitality", "ember_sprite", "heat_gust"],
		"kit_q": "ember_entangle",
		"kit_e": "ember_firebomb",
	...
	# --- Verdant world heroes ---
	{
		...
		"damage_taken_multiplier": 1.1,
		"taunt_weight": 1.0,
		"secondary": "bramble_snare",
		"secondary_cooldown": 10.0,
		"upgrades": ["flow", "lash", "heavy", "vitality", "thorn_sprite", "vine_tether"],
		"kit_q": "thorn_poison_spray",
		"kit_e": "thorn_toxicity",
	...
	},
	{
		...
		"secondary": "windstep",
		"secondary_cooldown": 9.0,
		"upgrades": ["rapid", "heavy", "boots", "vitality", "thorn_sprite", "vine_tether"],
	...
	},
	{
		...
		"secondary": "oak_bark",
		"secondary_cooldown": 11.0,
		"upgrades": ["plating", "reach", "sweep", "flow", "vitality", "thorn_sprite", "vine_tether"],
		"kit_q": "stump_natures_rally",
		"kit_e": "stump_root_charge",
	...
	},
	{
		...
		"taunt_weight": 1.3,
		"hovering": true,
		"secondary": "bloom_mend",
		"secondary_cooldown": 10.0,
		"upgrades": ["flow", "lash", "boots", "vitality", "thorn_sprite", "vine_tether"],
		"kit_q": "sage_petal_dance",
	...
	# --- Storm world heroes ---
	{
		...
		"counters": "Strong vs melee packs",
		"damage_type": DamageType.LIGHTNING,
		"weapon": Weapon.CHAIN_BOLT,
		"effect_style": EffectStyle.BOLT,
		"body_color": "e8e8e8",
		...
		"secondary": "gale_gust",
		"secondary_cooldown": 9.0,
		"upgrades": ["rapid", "chain", "heavy", "vitality", "spark_sprite", "gale_push"],
		"kit_q": "volt_gust",
		"kit_e": "volt_plasma_bolt",
		"kit_r": "volt_typhoon",
		"ability_pool": [
	...
	},
	{
		...
		"secondary": "time_skip",
		"secondary_cooldown": 11.0,
		"upgrades": ["rapid", "heavy", "boots", "vitality", "spark_sprite", "gale_push"],
		"kit_q": "nebula_arcane_bolt",
	...
	},
	{
		...
		"taunt_weight": 1.3,
		"hovering": true,
		"secondary": "ward_light",
		"secondary_cooldown": 10.0,
		"upgrades": ["flow", "lash", "choir", "vitality", "spark_sprite", "gale_push"],
		"kit_q": "astral_ghastly_touch",
		"kit_e": "astral_moonfall",
		"kit_r": "astral_as_one",
		"ability_pool": [
	...
	},
	{
		...
		"damage_taken_multiplier": 1.0,
		"taunt_weight": 1.15,
		"secondary": "glacial_nova",
		"secondary_cooldown": 10.0,
		"upgrades": ["depth", "rime", "heavy", "vitality", "spark_sprite", "gale_push"],
...
const UPGRADES: Dictionary = {
	...
	"gun_drone": {"name": "Gun Drone", "description": "A small drone follows you and shoots nearby enemies"},
	"push_drone": {"name": "Repulsor Drone", "description": "A drone that shoves enemies away from you"},
	"ember_sprite": {"name": "Cinder Sprite", "description": "A fire wisp orbits you and burns foes"},
	"heat_gust": {"name": "Heat Gust", "description": "A hot burst familiar that knocks enemies back"},
	"thorn_sprite": {"name": "Thorn Sprite", "description": "A vine familiar that stings nearby enemies"},
	"vine_tether": {"name": "Vine Tether", "description": "A root familiar that slows packs around you"},
	"spark_sprite": {"name": "Spark Familiar", "description": "A storm spark that zaps the nearest enemy"},
	"gale_push": {"name": "Gale Disc", "description": "A wind disc that knocks enemies off you"},
}
...
const ABILITIES: Dictionary = {
	...
	"arclight_blast_of_lightning": {
		"name": "Jolt", "archetype": Archetype.NUKE_BOLT,
		"description": "A fast static jolt zaps the target point up to {range} range, dealing {power} Magic damage instantly.",
		"cooldown_base": 3.2, "cooldown_per_rank": -0.35, "cooldown_min": 1.6,
		"power_base": 70.0, "power_per_rank": 18.0, "range": 560.0,
	},
	"arclight_chain_lightning": {
		...
		"cooldown_base": 8.0, "cooldown_per_rank": -0.8, "cooldown_min": 4.5,
		"power_base": 44.0, "power_per_rank": 12.0, "range": 640.0,
		"chain_count": 9, "chain_range": 300.0,
	},
	"arclight_thundergods_wrath": {
		"name": "Tempest Call", "archetype": Archetype.RADIUS_BURST,
		"description": "Calls down a massive sky-bolt that splits into {chain_count} lightning arcs across the battlefield, dealing {power} Magic damage and stunning for {stun_duration}s.",
		"cooldown_base": 45.0, "cooldown_per_rank": -3.8, "cooldown_min": 28.0,
		"power_base": 200.0, "power_per_rank": 48.0, "range": 0.0, "radius": 999.0,
		"stun_on_hit": {"duration": 0.6},
		"sky_strike": true, "sky_delay": 0.6, "chain_count": 8, "chain_range": 420.0,
	},
	"arclight_static_bolt": {
		"name": "Static Bolt", "archetype": Archetype.NUKE_BOLT,
		"description": "A quick static bolt strikes the target point up to {range} range, dealing {power} Magic damage.",
		"cooldown_base": 2.6, "cooldown_per_rank": -0.3, "cooldown_min": 1.4,
		"power_base": 52.0, "power_per_rank": 14.0, "range": 600.0,
	},
	"arclight_overcharge": {
	...
	"bulwark_sunder": {
		...
		"power_base": 28.0, "power_per_rank": 8.0, "range": 230.0,
