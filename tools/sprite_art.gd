...
const SHAPE_SECONDARY_VINE_TANGLE := [  # Warden peel — vines knot, snare the pack
	"..e..e..",
	".eeffee.",
	"e.fllf.e",
	".flaalf.",
...
const SHAPE_SECONDARY_ICE_BLOCK := [
	"..ffff..",
	".faaaaf.",
	"faalllfa",
	"falllafl",
...
const SHAPE_SECONDARY_HEAT_BURST := [
	"...ff...",
	"..flff..",
	".fllllf.",
	"fllallf.",
...
const SHAPE_SECONDARY_BLAST_JUMP := [
	"...aa...",
	"..affa..",
	".affffa.",
	"affffffa",
...
const SHAPE_SECONDARY_MAGMA_ARMOR := [
	"..ffff..",
	".ffaaff.",
	"ffalaaff",
	"falllaaf",
...
const SHAPE_SECONDARY_CINDER_VEIL := [
	"...ee...",
	"..effe..",
	".efllfe.",
	"eflaalef",
...
const SHAPE_SECONDARY_WINDSTEP := [
	"........",
	".ff.....",
	"..ff.f..",
	"...ffff.",
...
const SHAPE_SECONDARY_OAK_BARK := [
	"...ff...",
	"..fllf..",
	".fllllf.",
	"fllaallf",
...
const SHAPE_SECONDARY_BLOOM_MEND := [
	"...ee...",
	"..eaae..",
	".eaffaee",
	"eeffafee",
...
const SHAPE_SECONDARY_GALE_GUST := [
	"f.....f.",
	".ff..ff.",
	"..ffff..",
	"...ll...",
...
const SHAPE_SECONDARY_TIME_SKIP := [
	"..ffff..",
	".f.aa.f.",
	"ffa.aaff",
	"ffa.aaff",
...
const SHAPE_SECONDARY_WARD_LIGHT := [
	"...aa...",
	"..affa..",
	".affffa.",
	"aaffafaa",
...
const ABILITY_ICON_ROWS := {
	...
	"tobor_energy_absorption": SHAPE_SHIELD_BURST,
	"tobor_boiler_burst": SHAPE_RADIUS_BURST,
	"tobor_keg_lob": SHAPE_KIT_TOBOR_Q,
	"tobor_turret_overdrive": SHAPE_KIT_TOBOR_E,
	"tobor_scrap_shield": SHAPE_SHIELD_BURST,
	"tobor_wrench_toss": SHAPE_NUKE_BOLT,
	"tobor_repair_pulse": SHAPE_SELF_HEAL,
	"tobor_ironclad_chassis": SHAPE_SHIELD_BURST,
	...
	"cinder_dragon_fire": SHAPE_CONE_BURST,
	"cinder_pillar_of_flame": SHAPE_RADIUS_BURST,
	"cinder_firebomb": SHAPE_RADIUS_BURST,
	"cinder_scorch": SHAPE_RADIUS_BURST,
	"cinder_ignite": SHAPE_RADIUS_BURST,
	"cinder_combustion_wave": SHAPE_CONE_BURST,
	"cinder_flame_dash": SHAPE_DASH_STRIKE,
	"cinder_magma_armor": SHAPE_SHIELD_BURST,
	"cinder_heat_surge": SHAPE_BUFF_SELF,
	"cinder_pyroclasm": SHAPE_RADIUS_BURST,
	...
	"stump_natures_rally": SHAPE_KIT_STUMP_Q,
	"stump_natures_veil": SHAPE_BUFF_SELF,

	# --- Sage (Nymphel) kit ---
	"sage_grace_of_the_nymph": SHAPE_KIT_SAGE_Q,
	"sage_volatile_pod": SHAPE_KIT_SAGE_E,
	"sage_charm": SHAPE_KIT_SAGE_R,
	"sage_grace": SHAPE_KIT_SAGE_Q,
	"sage_nymphoras_kiss": SHAPE_AOE_HEAL,
...
const ABILITY_ICON_PALETTES := {
	...
	"tobor_energy_absorption": HERO_ABILITY_TONES.tobor,
	"tobor_boiler_burst": HERO_ABILITY_TONES.tobor,
	"tobor_keg_lob": HERO_ABILITY_TONES.tobor,
	"tobor_turret_overdrive": HERO_ABILITY_TONES.tobor,
	"tobor_scrap_shield": HERO_ABILITY_TONES.tobor,
	"tobor_wrench_toss": HERO_ABILITY_TONES.tobor,
	"tobor_repair_pulse": HERO_ABILITY_TONES.tobor,
	"tobor_ironclad_chassis": HERO_ABILITY_TONES.tobor,
	...
	"cinder_dragon_fire": HERO_ABILITY_TONES.cinder,
	"cinder_pillar_of_flame": HERO_ABILITY_TONES.cinder,
	"cinder_firebomb": HERO_ABILITY_TONES.cinder,
	"cinder_scorch": HERO_ABILITY_TONES.cinder,
	"cinder_ignite": HERO_ABILITY_TONES.cinder,
	"cinder_combustion_wave": HERO_ABILITY_TONES.cinder,
	"cinder_flame_dash": HERO_ABILITY_TONES.cinder,
	"cinder_magma_armor": HERO_ABILITY_TONES.cinder,
	"cinder_heat_surge": HERO_ABILITY_TONES.cinder,
	"cinder_pyroclasm": HERO_ABILITY_TONES.cinder,
	...
	"stump_natures_rally": HERO_ABILITY_TONES.stump,
	"stump_natures_veil": HERO_ABILITY_TONES.stump,
	...
	"sage_grace": HERO_ABILITY_TONES.sage,
	"sage_nymphoras_kiss": HERO_ABILITY_TONES.sage,
...
const SECONDARY_ICON_ROWS := {
	...
	"secondary_vine_tangle": SHAPE_SECONDARY_VINE_TANGLE,
	"secondary_ice_block": SHAPE_SECONDARY_ICE_BLOCK,
	"secondary_heat_burst": SHAPE_SECONDARY_HEAT_BURST,
	"secondary_blast_jump": SHAPE_SECONDARY_BLAST_JUMP,
	"secondary_magma_armor": SHAPE_SECONDARY_MAGMA_ARMOR,
	"secondary_cinder_veil": SHAPE_SECONDARY_CINDER_VEIL,
	"secondary_bramble_snare": SHAPE_SECONDARY_BRAMBLE,
	"secondary_windstep": SHAPE_SECONDARY_WINDSTEP,
	"secondary_oak_bark": SHAPE_SECONDARY_OAK_BARK,
	"secondary_bloom_mend": SHAPE_SECONDARY_BLOOM_MEND,
	"secondary_gale_gust": SHAPE_SECONDARY_GALE_GUST,
	"secondary_time_skip": SHAPE_SECONDARY_TIME_SKIP,
	"secondary_ward_light": SHAPE_SECONDARY_WARD_LIGHT,
	"secondary_glacial_nova": SHAPE_SECONDARY_GLACIAL,
}
...
const SECONDARY_ICON_PALETTES := {
	...
	"secondary_vine_tangle": {"o": "0d2b1a", "f": "5cd485", "l": "d9ffe0", "a": "8cff4a", "e": "2f6a30"},
	"secondary_ice_block": {"o": "0a2233", "f": "7fd4ff", "l": "cfe8ff", "a": "ffffff"},
	"secondary_heat_burst": {"o": "2a0a05", "f": "ff6a20", "l": "ffc46b", "a": "fff0b8"},
	"secondary_blast_jump": {"o": "2a0a05", "f": "e05a28", "l": "ff8a3d", "a": "ffe14a"},
	"secondary_magma_armor": {"o": "2a0a05", "f": "c45a20", "l": "ff8a3d", "a": "ffe08c"},
	"secondary_cinder_veil": {"o": "1a0804", "f": "ff8a3d", "l": "ffd36b", "a": "fff0b8", "e": "6b2a10"},
	"secondary_bramble_snare": {"o": "14200c", "f": "4a8a38", "l": "7ab84a", "e": "2f5a28"},
	"secondary_windstep": {"o": "0a1e14", "f": "8cff4a", "l": "d9ffe0"},
	"secondary_oak_bark": {"o": "1a140c", "f": "6b4a2c", "l": "4a8a38", "a": "3a2818"},
	"secondary_bloom_mend": {"o": "0d2b1a", "f": "5cd485", "l": "d9ffe0", "a": "ffe9f2", "e": "d86f9b"},
	"secondary_gale_gust": {"o": "0a2233", "f": "7af0ff", "l": "eafcff"},
	"secondary_time_skip": {"o": "1a0a28", "f": "c47bff", "l": "e8d0ff", "a": "7af0ff"},
	"secondary_ward_light": {"o": "1a1408", "f": "ffe14a", "l": "fff3cf", "a": "ffffff"},
	"secondary_glacial_nova": {"o": "0a2233", "f": "7fd4ff", "l": "eafcff", "a": "ffffff"},
}
...
const TERRAIN_PALETTES := {
	...
	"grass_long": {"c": "3a6130", "d": "47743a", "l": "5c8f47", "h": "7aab55"},
	"grass_flower": {"c": "3a6130", "d": "47743a", "p": "d86f9b", "w": "ffe9f2"},
	"grass_bloom": {"c": "3a6130", "d": "47743a", "y": "e8c25a", "w": "fff3cf"},
	"grass_lush": {"a": "1a3014", "b": "243c1c", "c": "162814", "d": "2f4f26"},
	"grass_meadow": {"a": "3a6130", "b": "47743a", "c": "2f4f26", "d": "5c8f47"},
	"dirt_tile": {"a": "4a3a28", "b": "5c4a32", "c": "3a2e20", "d": "6b5a40"},
	...
	"rock_jagged": {"o": "16191f", "s": "424b58", "m": "626d80", "h": "8b96a8", "g": "3f6a37"},
	"grass_wild": {"c": "3a6130", "d": "47743a", "l": "5c8f47", "h": "7aab55"},
	"flower_patch": {"c": "3a6130", "d": "47743a", "p": "d86f9b", "w": "ffe9f2", "y": "e8c25a"},
...
static func all_sprites() -> Dictionary:
	...
	var tw_art := preload("res://tools/tobor_world_art.gd")
	for tree_id in [
		"tree_oak", "tree_pine", "tree_dead", "tree_pipe", "tree_piling",
		"tree_willow", "tree_round", "tree_fir", "tree_palm", "tree_cypress", "tree_maple",
	]:
		if tw_art.TERRAIN_ROWS.has(tree_id) and TERRAIN_PALETTES.has(tree_id):
			sprites[tree_id] = {
				"rows": tw_art.TERRAIN_ROWS[tree_id],
				"palette": TERRAIN_PALETTES[tree_id],
			}
	var tw_sprites := tw_art.all_sprites()
