...
const VOLUME_DB := {
	...
	"attack_secondary_tobor": -8.0,
	"attack_secondary_arclight": -9.0,
	"attack_secondary_bulwark": -7.0,
	"attack_secondary_warden": -9.0,
	"attack_secondary_cinder": -8.0,
	"attack_secondary_pyra": -8.0,
	"attack_secondary_slag": -7.0,
	"attack_secondary_ember": -9.0,
	"attack_secondary_thorn": -9.0,
	"attack_secondary_willow": -9.0,
	"attack_secondary_stump": -8.0,
	"attack_secondary_sage": -9.0,
	"attack_secondary_volt": -9.0,
